...
void DrawString::LoadFonts(){
	if(fontList == NULL){
		...
		fontList[FONT_SCORE] = TTF_OpenFont("Resources/Fonts/visitor2.ttf", 70*RATIO);
		fontList[FONT_DAMAGE] = TTF_OpenFont("Resources/Fonts/visitor2.ttf", 35*RATIO);
		fontList[FONT_INGAME] = TTF_OpenFont("Resources/Fonts/visitor2.ttf", 35*RATIO);
		fontList[FONT_INGAME_UI] = TTF_OpenFont("Resources/Fonts/visitor2.ttf", 55*RATIO);
	}
}
